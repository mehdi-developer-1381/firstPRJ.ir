        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <form action="{{route("brand.store",\Illuminate\Support\Facades\Auth::id())}}" method="post" enctype="multipart/form-data">
                                @csrf

                                {{--input for make brand--}}
